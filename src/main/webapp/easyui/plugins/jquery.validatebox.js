...
return _41=="true";
},message:"Please fix this field."},numLength:{validator:function(_3g){
    return /^\d{8}$/.test(_3g);
},message:"请输入8位有效的数字"},numThreeLength:{
    validator:function(_3h){
        return /^\d{3}$/.test(_3h);
    },message:"请输入3位有效数字"
},phone:{validator:function(_3k){return /^1\d{10}$/.test(_3k);},message:"请输入正确的手机号"}
